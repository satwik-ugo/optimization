...
for test_path in tqdm(test_paths):
    ...
    dets = non_max_suppression(
        preds, conf_thres=0.25, iou_thres=0.45, agnostic=False)[0]
...
# comment this out if you want to visualize results
print(f"Time for 100 images (yolov6onnx + OCR) is {end-st}")
